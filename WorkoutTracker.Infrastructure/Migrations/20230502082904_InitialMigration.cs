    ...
    public partial class InitialMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    WorkoutSessionId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    WorkoutScore = table.Column<double>(type: "float(2)", precision: 2, nullable: false, defaultValue: 0.0),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Sets = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Exercises", x => new { x.ExerciseId, x.WorkoutSessionId });
                    table.ForeignKey(
